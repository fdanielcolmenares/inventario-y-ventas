		...
		<div class="span8">
			...
			if(isset($_GET['E']) && $_GET['E'] == '1'){
				...
				<div class="alert alert-success">
					...
					<strong>Articulo creado exitosamente</strong> 
				</div>';
			}
			if(isset($_GET['E']) && $_GET['E'] == '0'){
				...
				<div class="alert alert-error">
					<button type="button" class="close" data-dismiss="alert">&times;</button>
					<strong>Articulo no registrado exitosamente</strong>
				</div>';
			}
			?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="codigo" name="codigo" type="text" placeholder="FFAA01L" class="input-large" required>  
                <div id="InfoC"></div>              
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="desc" name="desc" type="text" placeholder="Furla Naranja" class="input-large" required>                
              </div>
            </div>
