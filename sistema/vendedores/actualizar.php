<?php 
	...
	$bd=Conectarse();
	$nombre="";
	//echo "hola ".$_FILES['imgV']['tmp_name'];
	...
	$sql="update vendedor set Nombre='".$_POST["nombre"]."', Apellido='".$_POST["apellido"]."', correo='".$_POST["correo"]."', estado='".$_POST["estado"]."', foto='".$nombre."' where codigo_vendedor=".$_POST["id"]."";
	$res=mysql_query($sql);
	if($res){
		echo'
			 <script type="text/javascript">
  				window.location="modificaVendedor.php?E=1";
			 </script>
		';	
	}
	else{
		echo'
			 <script type="text/javascript">
  				window.location="modificaVendedor.php?E=0";
			 </script>
		';		
	}
?>